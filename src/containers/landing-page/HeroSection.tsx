		...
		<section className="relative w-full bg-white">
			...
			<div className="hidden lg:flex flex-row h-[40.625rem]">
				...
				<div className="flex flex-col justify-end gap-8 px-10 py-[3.75rem] pb-10 bg-white w-[32.5rem]">
					...
					<h1 className="text-[4.375rem] leading-[0.88] tracking-[0.04375rem] text-[#0f0f0f] font-staatliches">
						Crafting
						<br />
						thoughtful
						<br />
					...
					<p className="text-[#7c7c7c] text-[0.875rem] leading-[1.6] tracking-[-0.0175rem] max-w-[21.875rem] font-geist">
						Based in Taipei. Building interfaces
						<br />
						that feel as good as they look.
					</p>
					<Button className="rounded-full bg-[#0f0f0f] text-white px-8 py-3 text-sm hover:bg-[#2c2825] transition-colors w-fit font-geist">
						View my work
					</Button>
				</div>
			...
			<div className="hidden md:flex lg:hidden flex-col h-[32.5rem]">
				{/* Hero Image - Top */}
				<div className="relative h-[17.5rem] bg-gray-100">
					<Image
						src="https://images.unsplash.com/photo-1571128973497-2066dda438bc?w=1080&q=80"
						alt="Coffee and notebook on wooden table"
						fill
				...
				<div className="flex flex-col gap-5 px-6 py-[1.875rem] bg-white">
					...
					<h1 className="text-[3.25rem] leading-[0.9] tracking-[0.0325rem] text-[#0f0f0f] font-staatliches">
						Crafting
						<br />
						thoughtful
						<br />
					...
					<p className="text-[#7c7c7c] text-sm leading-[1.6] tracking-[-0.00875rem] font-geist">
						Based in Taipei. Building interfaces that feel as good as they look.
					</p>
					<Button className="rounded-full bg-[#0f0f0f] text-white px-7 py-2.5 text-sm hover:bg-[#2c2825] transition-colors w-fit font-geist">
						View my work
					</Button>
				</div>
			</div>
