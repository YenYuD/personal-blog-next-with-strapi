...
export default function HeroSection() {
	...
	return (
		...
		>
			...
			<div className="order-2 md:order-2 lg:order-1 flex flex-col justify-end gap-4 md:gap-5 lg:gap-8 px-5 md:px-6 lg:px-10 py-6 md:py-[1.875rem] lg:py-[3.75rem] lg:pb-10 bg-white w-full lg:w-[32.5rem]">
				<motion.p
					{...fadeInLeft}
				...
				<motion.div
					...
					className="w-fit"
				>
					<Button className="rounded-full bg-[#0f0f0f] text-white px-6 md:px-7 lg:px-8 py-2.5 md:py-2.5 lg:py-3 text-sm hover:bg-[#2c2825] transition-colors font-geist">
						View my work
					</Button>
				</motion.div>
			</div>
			...
			<motion.div
				{...fadeInRight}
				className="order-1 md:order-1 lg:order-2 relative h-[13.75rem] md:h-[17.5rem] lg:h-full flex-1 bg-gray-100 overflow-hidden"
			>
